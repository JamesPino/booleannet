"""
Grammar file for a boolean2 parser based on PLY
"""
import random
from boolean2 import tokenizer, util
...
def p_expression_state(p):
    ...
    # plde mode will transforms the boolean2 values to triplets
...
class Parser(object):
    ...
    def __init__(self, mode, text):
        ...
        self.parser.sync = (
                    self.parser.mode == SYNC or self.parser.mode == TIME)
